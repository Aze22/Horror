...
public class vp_FPSCamera : vp_Component
{
	...
	public float cameraSensitivity = 0.08f;
	...
	public void SetCameraRotationInput(float x, float y) {
	
		m_MouseMove.x = x * cameraSensitivity;
		m_MouseMove.y = y * cameraSensitivity;
